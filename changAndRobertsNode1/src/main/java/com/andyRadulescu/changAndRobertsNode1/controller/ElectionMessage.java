package com.andyRadulescu.changAndRobertsNode1.controller;

import com.andyRadulescu.changAndRobertsNode1.service.PostToNextBackend;
...
public class ElectionMessage {
    ...
    public Integer getMessage() {
        return postToNextBackend.postToNextNode(nodeValue, "election");
    }

    @PostMapping(value = "/election")
    public Integer getNodeValue(@RequestBody String incomeNodeValueString) {
